...
namespace WebSite.Helpers.Authentication
{
    abstract class AuthenticationClient : WebServerClient
    {
        ...
        /// </summary>
        /// <returns></returns>
        public UserIdentity GetUserIdentity(string returnUrl)
        {
        ...
        /// to a <see cref="UserIdentity"/>.
        /// </summary>
        protected abstract UserIdentity HandleResponseStream(System.IO.Stream responseStream);
    }
}